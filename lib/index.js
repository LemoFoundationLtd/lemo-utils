...
export const encodeCustomTxData = hex.encodeCustomTxData
export const decodeCustomTxData = hex.decodeCustomTxData
...
export default {
    ...
    encodeCustomTxData: hex.encodeCustomTxData,
    decodeCustomTxData: hex.decodeCustomTxData,
